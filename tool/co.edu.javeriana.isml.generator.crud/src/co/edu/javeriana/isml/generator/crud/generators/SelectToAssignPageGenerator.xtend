...
class SelectToAssignPageGenerator extends SimpleGenerator<Entity> {
	@Inject extension IQualifiedNameProvider
	@Inject extension CommonTemplates

	override protected getFileName(Entity e) {
		e.eContainer?.fullyQualifiedName.toString("/").toLowerCase + "/" + e.selectToAssignPage + ".isml"
	}
	...
	override getTemplate() {
		new SelectToAssignPageTemplate
	}
