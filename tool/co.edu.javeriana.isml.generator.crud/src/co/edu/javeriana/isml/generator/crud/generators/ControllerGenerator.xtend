...
class ControllerGenerator extends SimpleGenerator<Entity> {
	@Inject extension IQualifiedNameProvider
	@Inject extension CommonTemplates	

	override protected getFileName(Entity e) {
		e.eContainer?.fullyQualifiedName.toString("/").toLowerCase + "/" + e.controllerName + ".isml"
	}

	override protected getOutputConfigurationName() {
		CRUDGenerator.CONTROLLERS
	}
